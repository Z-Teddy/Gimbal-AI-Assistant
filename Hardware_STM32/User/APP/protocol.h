 ...
 * 协议指令常量 (Command IDs)
 * ================================================================================= */
#define PROT_CMD_TRACK_FACE     0x02    /*!< 指令: 人脸追踪坐标数据 */
#define PROT_CMD_SET_ANGLE      0x03    /*!< 指令: 设定绝对角度 (语音强控) */
#define PROT_CMD_SET_EXPRESSION 0x04    /*!< 指令: 设定表情显示 */
...
/* 全局状态变量 */
extern SystemMode_t g_SystemMode;   /*!< 当前系统运行模式 */
